...
class CreateCaregiverTest extends TestCase
{
    ...
    /** @test  */
    public function non_skilled_nurses_do_not_require_licence_information()
    {
        $caregiverAttributes = factory(Caregiver::class)->raw([
    ...
    /** @test  */
    public function skilled_nurses_do_require_licence_information()
    {
        $caregiverAttributes = factory(Caregiver::class)->raw([
        ...
        $response
            ->assertStatus(302)
            ->assertSessionHasErrors(['licence_number', 'licence_expiration']);
    }

    /** @test  */
    public function skilled_nurses_can_be_created_with_licence_information()
    {
        $caregiverAttributes = factory(Caregiver::class)->raw([
            'position' => 'Skilled Nurse',
            'licence_number' => '123456',
            'licence_expiration' => '2020-01-01'
        ]);
